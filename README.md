...
Double-click `vault-windows.bat` from the repo folder at any time — installs on first run, starts Vault on subsequent runs. Docker Desktop does not need to be installed. If it was just installed, the script will ask you to restart and re-run.
